...
Here is the Entity Relationship Diagram of the stock market data after conversion of csv into sqlite file![ERD_market.png](Sector_htmls/Images/ERD_market.png).
